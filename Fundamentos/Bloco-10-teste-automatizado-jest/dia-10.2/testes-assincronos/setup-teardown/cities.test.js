...
/* 
  O beforeEach e o afterEach quando encapsulados dentro do 'describe',
  vao rodar somente dentro daquele escopo.

  beforeEach -> executa antes de cada teste evitando ter que repetir o mesmo
  codigo diversas vezes. Bom pra evitar re-inicializacao de variaveis, etc.
  
  afterEach -> Especialmente util para resetar os dados usados no beforeEach

  A recomendacao eh agrupar dentro do describe junto com os testes.
*/
